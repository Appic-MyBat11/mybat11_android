...
public class QuizLiveChallengeListAdapter extends BaseAdapter {
    ...
    public QuizLiveChallengeListAdapter(Context context, ArrayList<JoinedChallengesGetSet> list){
