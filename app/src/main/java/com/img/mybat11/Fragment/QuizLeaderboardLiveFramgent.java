...
import com.img.mybat11.Adapter.QuizDoneLeaderBoardAdapter;
 ...
 */
public class QuizLeaderboardLiveFramgent extends Fragment {
    ...
    String TAG = "Data";
    QuizDoneLeaderBoardAdapter adapter;
    ...
    public QuizLeaderboardLiveFramgent() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_quiz_leaderboard_live_framgent, container, false);
        context = getActivity();
        ...
        call.enqueue(new Callback<ArrayList<LiveChallengesGetSet>>() {
            ...
            public void onResponse(Call<ArrayList<LiveChallengesGetSet>> call, Response<ArrayList<LiveChallengesGetSet>> response) {
                ...
                if(response.code() == 200) {
                    ...
                    totalTeams.setText(teams.size()+" Teams");
                    ...
                    if (teams != null) {
                        ...
                        adapter = new QuizDoneLeaderBoardAdapter(context, teams1);
