...
public class UserSessionManager {
    ...
    private static final String popupurl = "";
    ...
    public void createUserLoginSession(boolean login, String id,String email) {
    ...
    public void setPopupurl(String amount){
        editor.putString(popupurl,amount);
        editor.commit();
    }
    ...
    public String getPopupurl() {
        return sharedPreferences.getString(popupurl,"");
    }
