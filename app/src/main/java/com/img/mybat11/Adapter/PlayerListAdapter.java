...
public class PlayerListAdapter extends BaseAdapter {
    ...
    public PlayerListAdapter(Context context, ArrayList<PlayerListGetSet>list, ArrayList<PlayerListGetSet>list1, boolean edit, String type){
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final View v;
        final TextView name,point,credit,teamName,enabledBG,role;
        CircleImageView img;
        ImageView select;
        ...
        if (list.get(i).getTeamname() == null) {
            ...
            teamName.setText(list.get(i).getTeamname().toUpperCase());
        }
        credit.setText(list.get(i).getCredit());
        if(list.get(i).getRole().equals("keeper"))
            role.setText("WK");
        else if(list.get(i).getRole().equals("batsman"))
            role.setText("BAT");
        else if(list.get(i).getRole().equals("allrounder"))
            role.setText("AR");
        else if(list.get(i).getRole().equals("bowler"))
            role.setText("BOWL");

        leftPlayers=(TextView) ((CreateTeamActivity)context).findViewById(R.id.leftPlayers);
        leftAmount=(TextView) ((CreateTeamActivity)context).findViewById(R.id.leftAmount);
        team1_size=(TextView) ((CreateTeamActivity)context).findViewById(R.id.team1);
        team2_size=(TextView) ((CreateTeamActivity)context).findViewById(R.id.team2);
        btnContinue=(Button) ((CreateTeamActivity)context).findViewById(R.id.btnContinue);
        counterll=(LinearLayout) ((CreateTeamActivity)context).findViewById(R.id.counterll);
        playersTab=(TabLayout)((CreateTeamActivity)context).findViewById(R.id.playersTab);
            ...
            for(PlayerListGetSet zz: list1){
                if(zz.isSelected()){
                    ...
                    if(type.equals("classic"))
                        ...
                        leftAmount.setText(String.format("%.1f", (45.0f-cr)));
                }
        ...
        if(type.equals("classic")) {
            ...
            playersTab.getTabAt(0).setText("AR (" + countALL1 + ")");
            playersTab.getTabAt(1).setText("BOWL (" + countBALL1 + ")");
        }
        ...
        if(type.equals("classic")) {
            ...
            for (int k = 0; k < count; k++) {
                ...
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(pxFromDp(48.0f, context), pxFromDp(30.0f, context));
                lp.setMargins(pxFromDp(-8.9f, context), pxFromDp(-6.0f, context), pxFromDp(-8.9f, context), pxFromDp(-6.0f, context));
                ll.setLayoutParams(lp);
                ImageView im = new ImageView(context);
                im.setImageDrawable(context.getResources().getDrawable(R.drawable.star_selected));
                ll.addView(im);
            ...
            for (int k = 0; k < left_count; k++) {
                ...
                ll.setLayoutParams(lp);
                ImageView im = new ImageView(context);
                im.setImageDrawable(context.getResources().getDrawable(R.drawable.star_deselcted));
                ll.addView(im);
        ...
        if(count == 11 && type.equals("classic")) {
        ...
        }else if(count == 10 && type.equals("classic")) {
        ...
        }else if(count == 5 && !type.equals("classic")) {
            btnContinue.setEnabled(true);
            btnContinue.setTextColor(context.getResources().getColor(R.color.white));
            btnContinue.setBackgroundDrawable(context.getDrawable(R.drawable.btn_green));
        }else if(count == 4 && !type.equals("classic")) {
            btnContinue.setEnabled(false);
            btnContinue.setTextColor(context.getResources().getColor(R.color.gray_text_color));
            btnContinue.setBackgroundDrawable(context.getDrawable(R.drawable.btn_gray));
        }
        ...
        v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(list.get(i).isSelected()){    //deselect player
                    ...
                    if(cr > 100.0f){
                        list.get(i).setSelected(false);
                        ma.showToast(context,"Not enough credit");
                    }
                    ...
                    if(type.equals("classic")) {
                        ...
                        if(c1>11){
                            list.get(i).setSelected(false);
                            ma.showToast(context,"You can select maximum 11 players in your team");
                        }
                        else if(countWK >4  || countBAT >6 || countBALL >6 || countALL >4 ){
                            list.get(i).setSelected(false);
                            if(countWK >4){
                                ma.showToast(context,"You can choose maximum 4 wicketkeeper");
                            }
                            else if(countBAT >6){
                                ma.showToast(context,"You can choose maximum 6 batsman");
                            }
                            if(countBALL >6){
                                ma.showToast(context,"You can choose maximum 6 bowlers");
                            }
                            if(countALL >4){
                                ma.showToast(context,"You can choose maximum 4 All-rounders");
                            }
                        }
                        else if(team1>7 || team2 >7){
                            list.get(i).setSelected(false);
                            ma.showToast(context,"You can select maximum of 7 players from a team");
                        }
                        else if(c1>10  &&(countBALL1<3  || countBAT1<3  || countWK1 <1 || countALL1 <1 )){
                            if(countBALL1<3){
                                list.get(i).setSelected(false);
                                ma.showToast(context,"Choose atleast 3 bowlers");
                            }
                            else if(countBAT1<3){
                                list.get(i).setSelected(false);
                                ma.showToast(context,"Choose atleast 3 batsman");
                            }
                            else if(countWK1==0){
                                list.get(i).setSelected(false);
                                ma.showToast(context,"Choose atleast 1 wicket-keeper");
                            }
                            else if(countALL1<1){
                                list.get(i).setSelected(false);
                                ma.showToast(context,"Choose atleast 1 All-rounder");
                            }
                        }
                        ...
                        if(c1>5){
                            list.get(i).setSelected(false);
                            ma.showToast(context,"You can select maximum 5 players in your team");
                        }
                        if (!type.equals("classic") && (team1 > 3 || team2 > 3)) {
                            list.get(i).setSelected(false);
                            ma.showToast(context, "You can select maximum of 3 players from a team");
                            b = false;
                        }
                    }
                }
