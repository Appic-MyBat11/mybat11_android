...
public class PasswordActivity extends AppCompatActivity {
    ...
    public void ForgetPassword(View v){
        Intent ii = new Intent(PasswordActivity.this,ForgetPasswordActivity.class);
        ii.putExtra("email",email.getText().toString());
        startActivity(ii);
    }

    public void Login(){
        ma.showProgressDialog(PasswordActivity.this);
        try {
                        ...
                        public void onResponse(String response)
                        {
                            try {
                                ...
                                if(jsonObject.getBoolean("status")){
                                    ...
                                    ma.errorDialog(PasswordActivity.this, jsonObject.getString("msg"), new View.OnClickListener() {
                                        @Override
                                        public void onClick(View v) {
                                            ma.dismissDialog();
                                        }
                    ...
                    new com.android.volley.Response.ErrorListener()
                    {
                        ...
                        public void onErrorResponse(VolleyError error)
                        {
                            ...
                            if (networkResponse != null && networkResponse.statusCode == HttpStatus.SC_UNAUTHORIZED) {
                                ...
                                ma.showToast(PasswordActivity.this,"Session Timeout");
