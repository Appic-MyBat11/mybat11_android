    ...
    private class DownloadFile extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                folder = Environment.getExternalStorageDirectory() + File.separator + "CB " + getResources().getString(R.string.app_name) + "/";
        ...
        protected void onPostExecute(String message) {
            ...
            Toast.makeText(UpdateActivity.this, "Downloaded at: " + folder + fileName, Toast.LENGTH_SHORT).show();
            String PATH = Environment.getExternalStorageDirectory() + File.separator + "CB " + getResources().getString(R.string.app_name) + "/";
            install_apk(new File(PATH + "fantasy.apk"));
        }
    }
