...
public class RegisterActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if(mobile.getEditText().getText().toString().length() != 10)
    ...
    private void displayMessage(Profile profile){
        if(profile != null) {
            ...
            ma.showProgressDialog(RegisterActivity.this);
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess() == true) {
            ...
            {
                ma.showToast(RegisterActivity.this,"Email id not found,please try manually.");
            } else {
                        ...
                        public void onResponse(String response)
                        {
                            try {
                                ...
                                if(jsonObject.getBoolean("status")){
                                    ...
                                    ma.dismissProgressDialog();
                                    ma.errorDialog(RegisterActivity.this, jsonObject.getString("msg"), new View.OnClickListener() {
                                        @Override
                                        public void onClick(View v) {
                                            ma.dismissDialog();
                                        }
                    ...
                    new com.android.volley.Response.ErrorListener()
                    {
                        ...
                        public void onErrorResponse(VolleyError error)
                        {
                            ...
                            if (networkResponse != null && networkResponse.statusCode == HttpStatus.SC_UNAUTHORIZED) {
                                ...
                                ma.showToast(RegisterActivity.this,"Session Timeout");
