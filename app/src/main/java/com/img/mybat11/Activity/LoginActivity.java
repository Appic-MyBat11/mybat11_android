...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private void displayMessage(Profile profile){
        if(profile != null) {
            ...
            ma.showProgressDialog(LoginActivity.this);
    ...
    private void PrintHashKey() {
        try {
            PackageInfo info = getPackageManager().getPackageInfo("com.img.mybateleven", PackageManager.GET_SIGNATURES);
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess() == true) {
            ...
            {
                ma.showToast(LoginActivity.this,"Email id not found,please try manually.");
            } else {
                        ...
                        public void onResponse(String response)
                        {
                            try {
                                ...
                                if(jsonObject.getBoolean("status")){
                                    ...
                                    ma.errorDialog(LoginActivity.this, jsonObject.getString("msg"), new View.OnClickListener() {
                                        @Override
                                        public void onClick(View v) {
                                            ma.dismissDialog();
                                        }
                            ...
                            try {
                                ...
                                if(jsonObject.getBoolean("status")){
                                    ...
                                    /*if(jsonObject.getInt("mobile_status") == 0){
                                        ...
                                        session.createUserLoginSession(true, "bearer " + jsonObject.getString("userid"), FGemail);
                                        Details();
                                    }
                                }else{
                                    ma.dismissProgressDialog();
                    ...
                    new com.android.volley.Response.ErrorListener()
                    {
                        ...
                        public void onErrorResponse(VolleyError error)
                        {
                            ...
                            if (networkResponse != null && networkResponse.statusCode == HttpStatus.SC_UNAUTHORIZED) {
                                ...
                                ma.showToast(LoginActivity.this,"Session Timeout");
