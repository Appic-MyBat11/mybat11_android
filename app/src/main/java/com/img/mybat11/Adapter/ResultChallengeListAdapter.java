...
import com.img.mybat11.Activity.DetailsResultActivity;
...
public class ResultChallengeListAdapter extends BaseAdapter {
    ...
    ArrayList<LiveChallengesGetSet> list1;
    GlobalVariables gv;
    ...
    public ResultChallengeListAdapter(Context context, ArrayList<JoinedChallengesGetSet> list){
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        View v;
        TextView prizeMoney,numWinners,entryFee,joinedWith,points,rank,winAmount;
        ...
        winAmount=(TextView)v.findViewById(R.id.winAmount);
        ...
        if(list.get(i).getTotalwinning() > 0){
            winAmount.setText("\uD83D\uDCB7 Your Winning   ₹"+list.get(i).getTotalwinning());
        }
        ...
        View bottomSheet = ((ResultChallengeActivity)context).findViewById(R.id.bottom_sheet1);
        mBottomSheetBehavior1 = BottomSheetBehavior.from(bottomSheet);
        mBottomSheetBehavior1.setHideable(true);
        mBottomSheetBehavior1.setState(BottomSheetBehavior.STATE_HIDDEN);

        priceCard=(ExpandableHeightListView)((ResultChallengeActivity)context).findViewById(R.id.priceCard);
        ...
        v.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent ii= new Intent(context, DetailsResultActivity.class);
                gv.setChallengeId(list.get(i).getChallenge_id());
                if(!list.get(i).getName().equals(""))
                    ii.putExtra("title",list.get(i).getName());
                else{
