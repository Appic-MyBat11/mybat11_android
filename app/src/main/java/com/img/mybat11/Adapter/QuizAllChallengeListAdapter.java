...
public class QuizAllChallengeListAdapter extends RecyclerView.Adapter<QuizAllChallengeListAdapter.ViewHolder> {
    ...
    public QuizAllChallengeListAdapter(Context context, ArrayList<challengesGetSet> list){
        this.list= list;
