...
import com.img.mybat11.Adapter.PlayerListAdapter;
...
public class PlayersFragment extends Fragment {
    ...
    public PlayersFragment(ArrayList<PlayerListGetSet> list1, ArrayList<PlayerListGetSet> list, String Text, boolean edit, String type){
        this.list = list;
        this.list1 = list1;
        this.Text = Text;
        this.edit = edit;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        playersList.setAdapter(new PlayerListAdapter(context,list,list1,edit,type));
